...
class News(Frame):
    ...
    def get_headlines(self):
        try:
            ...
            traceback.print_exc()
            print ('Error:',e, '%s. Cannot get news.')
...
class Bustime(Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.bustimeLbl = Label(self, font=('Helvetica', large_text_size), fg="white", bg="black")
        self.bustimeLbl.pack(side=TOP, anchor=W)
        self.bustimeContainer = Frame(self, bg="black")
        self.bustimeContainer.pack(side=TOP)
        self.get_bustime()
    ...
    def get_bustime(self):
        try:
            ...
            traceback.print_exc()
            print ('Error:',e, 'Cannot get bus time')

        self.after(20000, self.get_bustime)
